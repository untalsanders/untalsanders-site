...
excerpt: >-
  If you are reading this article, it means you are already well-versed with
  JUnit.
coverImage: /images/cover-junit-5-parameterized-tests.webp
date: '2023-06-07T05:35'
author:
  name: Sanders Gutiérrez
  picture: /images/authors/sanders.jpeg
ogImage:
  url: /images/cover-junit-5-parameterized-tests.webp
preview: false
---
If you are reading this article, it means you are already well-versed with JUnit.
...
This article is accompanied by a working code example [on GitHub](https://github.com/thombergs/code-examples/tree/master/core-java/junit5-parameterized-tests).
