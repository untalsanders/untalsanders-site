...
excerpt: 'Las interfaces funcionales son una característica importante de Java introducida en la versión 8.'
coverImage: '/images/cover-interfaces-funcionales-en-java.webp'
