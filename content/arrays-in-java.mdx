...
excerpt: 'Los arrays en Java son una estructura de datos que nos permiten almacenar múltiples valores del mismo tipo en una sola variable. Estos valores se almacenan en una secuencia ordenada y se pueden acceder a ellos mediante un índice.'
coverImage: '/images/cover-arrays-in-java.webp'
